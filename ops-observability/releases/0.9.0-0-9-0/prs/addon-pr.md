...
- What changed: location activity panel with hotspots, exploration rate, traffic patterns, POI visits, zone control
- Files or areas touched: addon.json, web/index.html (Location section), web/addon.js (renderLocation), web/data-providers.js (location actions + sample data)
- Release or roadmap item: v0.9.0

## Why

- Problem being solved: Operators need location activity panel with hotspots, exploration rate, traffic patterns, POI visits, zone control visualization in the Dune Console UI
...
- Release notes: Incremental release adding to v0.9. Requires core PR for v0.9.0.
