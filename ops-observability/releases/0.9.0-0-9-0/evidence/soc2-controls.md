...
## Change Management
- Change summary: Location Activity bridge actions + addon UI panels
...
## Access Control
- Permission changes: ops:read (v0.3.0); no new permissions for v0.9.0
- New bridge actions: location.activity.*
