...
## Change Management
- Change summary: Activity Summary bridge actions + addon UI panels
...
## Access Control
- Permission changes: ops:read (v0.3.0); no new permissions for v0.4.0
- New bridge actions: activity.summary.*
