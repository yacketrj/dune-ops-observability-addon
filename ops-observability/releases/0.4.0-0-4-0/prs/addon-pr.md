...
- What changed: activity summary panel with daily active players, session duration, top play hours, activity trend, returning players
- Files or areas touched: addon.json, web/index.html (Activity section), web/addon.js (renderActivity), web/data-providers.js (activity actions + sample data)
- Release or roadmap item: v0.4.0

## Why

- Problem being solved: Operators need activity summary panel with daily active players, session duration, top play hours, activity trend, returning players visualization in the Dune Console UI
...
- Release notes: Incremental release adding to v0.4. Requires core PR for v0.4.0.
