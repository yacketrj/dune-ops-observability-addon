...
- What changed: economy summary panel with overview, trade routes, currency supply, market trends, guild wealth
- Files or areas touched: addon.json, web/index.html (Economy section), web/addon.js (renderEconomy), web/data-providers.js (economy actions + sample data)
- Release or roadmap item: v0.7.0

## Why

- Problem being solved: Operators need economy summary panel with overview, trade routes, currency supply, market trends, guild wealth visualization in the Dune Console UI
...
- Release notes: Incremental release adding to v0.7. Requires core PR for v0.7.0.
