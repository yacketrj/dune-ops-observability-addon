...
- What changed: resources summary panel with extraction rates, hotspots, inventory levels, trade volume, rarity distribution
- Files or areas touched: addon.json, web/index.html (Resources section), web/addon.js (renderResources), web/data-providers.js (resources actions + sample data)
- Release or roadmap item: v0.6.0

## Why

- Problem being solved: Operators need resources summary panel with extraction rates, hotspots, inventory levels, trade volume, rarity distribution visualization in the Dune Console UI
...
- Release notes: Incremental release adding to v0.6. Requires core PR for v0.6.0.
