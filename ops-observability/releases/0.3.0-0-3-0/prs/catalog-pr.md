...
- What changed: Add new addon listing for Dune Ops Observability v0.3.0
...
- Known limitations: Requires core PR for v0.3.0 to be merged first and addon release artifact available
