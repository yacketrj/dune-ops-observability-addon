...
## Change Management
- Change summary: OPS Health Bridge bridge actions + addon UI panels
...
## Access Control
- Permission changes: ops:read (v0.3.0); no new permissions for v0.3.0
- New bridge actions: ops.health.players, ops.health.farms, ops.health.summary.v2
