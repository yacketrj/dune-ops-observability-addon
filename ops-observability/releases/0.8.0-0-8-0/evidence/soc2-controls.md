...
## Change Management
- Change summary: Inventory Summary bridge actions + addon UI panels
...
## Access Control
- Permission changes: ops:read (v0.3.0); no new permissions for v0.8.0
- New bridge actions: inventory.summary.*
