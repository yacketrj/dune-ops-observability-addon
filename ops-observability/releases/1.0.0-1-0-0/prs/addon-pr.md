...
- What changed: SOC summary panel with DAU, system uptime, alerts, compliance, backup status, DR status, access audit
- Files or areas touched: addon.json, web/index.html (SOC section), web/addon.js (renderSOC), web/data-providers.js (SOC actions + sample data)
- Release or roadmap item: v1.0.0

## Why

- Problem being solved: Operators need SOC summary panel with DAU, system uptime, alerts, compliance, backup status, DR status, access audit visualization in the Dune Console UI
...
- Release notes: Incremental release adding to v1.0. Requires core PR for v1.0.0.
