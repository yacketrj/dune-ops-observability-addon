...
- What changed: Update Dune Ops Observability listing to v1.0.0 (version, SHA256, updatedAt)
...
- Known limitations: Requires core PR for v1.0.0 to be merged first and addon release artifact available
