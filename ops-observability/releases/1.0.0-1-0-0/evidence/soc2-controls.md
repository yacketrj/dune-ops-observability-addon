...
## Change Management
- Change summary: SOC Summary bridge actions + addon UI panels
...
## Access Control
- Permission changes: ops:read (v0.3.0); no new permissions for v1.0.0
- New bridge actions: soc.summary.*
