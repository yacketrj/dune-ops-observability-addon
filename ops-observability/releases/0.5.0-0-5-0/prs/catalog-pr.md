...
- What changed: Update Dune Ops Observability listing to v0.5.0 (version, SHA256, updatedAt)
...
- Known limitations: Requires core PR for v0.5.0 to be merged first and addon release artifact available
