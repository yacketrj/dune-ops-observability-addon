...
- What changed: combat deaths panel with faction breakdown, top PvP killers, top PvE victims, combat hotspots, weapon analysis
- Files or areas touched: addon.json, web/index.html (Combat section), web/addon.js (renderCombat), web/data-providers.js (combat actions + sample data)
- Release or roadmap item: v0.5.0

## Why

- Problem being solved: Operators need combat deaths panel with faction breakdown, top PvP killers, top PvE victims, combat hotspots, weapon analysis visualization in the Dune Console UI
...
- Release notes: Incremental release adding to v0.5. Requires core PR for v0.5.0.
