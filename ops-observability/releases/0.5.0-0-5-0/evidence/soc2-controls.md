...
## Change Management
- Change summary: Combat Deaths bridge actions + addon UI panels
...
## Access Control
- Permission changes: ops:read (v0.3.0); no new permissions for v0.5.0
- New bridge actions: combat.deaths.*
